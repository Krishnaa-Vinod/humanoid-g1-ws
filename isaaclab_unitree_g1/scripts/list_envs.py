...
All the environments are registered in the `isaaclab_unitree_g1` extension. They start
...
import isaaclab_unitree_g1.tasks  # noqa: F401


def main():
    """Print all environments registered in `isaaclab_unitree_g1` extension."""
